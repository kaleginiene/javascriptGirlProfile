...
const TextBox: React.FC = () => (
  <>
    <h2 className="text-lg font-medium mb-2">Side Work</h2>
    <div className="flex gap-3">
      <p>2023.04 - 2023-10</p>
      <p className="font-medium">Mentor @Women Go Tech</p>
    </div>
    ...
    <div className="flex gap-3 mt-3">
      <p>2021.09 - 2022-06</p>
      <p className="font-medium">React JS Lecturer @Kilo Academy</p>
    </div>
    <p className="font-medium">
    ...
    <div className="flex gap-3 mt-3">
      <p>2021.08 - 2022-08</p>
      <p className="font-medium">Freelance Front-end Engineer</p>
    </div>
    <p className="font-medium">
