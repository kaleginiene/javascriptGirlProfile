...
export const Statistics: React.FC = () => (
  <div className="bg-pink-100 w-full mt-11 py-4 mb-4 px-2 md:px-0">
    <div className="container flex gap-2 md:gap-0 items-start md:items-center justify-around font-raleway">
